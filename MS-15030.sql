...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15030';
DECLARE @Comments nvarchar(Max) = 
	'Add query text to cloned courses';
...
values
('Basic Course Information', 'Course', 'SubjectId','Ping')
...
SELECT CONCAT(s.SubjectCode, ' ', c2.CourseNumber) AS Text, 0 AS Value
FROM Course As c
...
VALUES
(@MAX, 'Course', 'Id', 'Title', @CSQL, @CSQL, 'Order By SortOrder', 'Course Clone query', 2)
