...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14134';
DECLARE @Comments nvarchar(Max) = 
	'Update Articulations Program Forms';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (18, 17)
...
values
('Codes and Dates', 'GenericDate', 'Date04','Update')
...
SET DisplayName = 'Next Program Review'
, MetaAvailableFieldId = 1091
, MetaPresentationTypeId = 33
, DefaultDisplayType = 'TelerikCombo'
, FieldTypeId = 5
, MetaForeignKeyLookupSourceId = 35
