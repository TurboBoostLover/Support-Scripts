...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14530';
DECLARE @Comments nvarchar(Max) = 
	'Add department drop down to minor course modification, major course modification, no credit course modification';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (3)
...
values
('Cover Screen', 'Course', 'SubjectId','Ping')
...
SET MetaAvailableFieldId = 3588
, DefaultDisplayType = 'Query Text'
, MetaPresentationTypeId = 36
, Width = 600
, Height = 24
,WidthUnit = 1
, HeightUnit = 1
...
VALUES
('FilterSourceColumn', 'SubjectId', @Field),
('FilterSourceTable', 'Course', @Field)
/****************************** update templates ******************************************/
update MetaTemplate
