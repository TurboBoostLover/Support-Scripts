...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13557';
...
values
('Program Sequencing', 'ProgramQueryText', 'QueryTextId_01','Update')
...
DECLARE @ctmSQL nvarchar(max)= "
declare @classOverrides stringtriple

insert into @classOverrides 
(String1, String2, String3)
values
('CourseEntryStatus','Wrapper','hidden course-entry-status')

exec upGenerateCourseBlockDisplay @entityId = @entityId, @elementClassOverrides = @classOverrides
"
SET QUOTED_IDENTIFIER ON

UPDATE MetaForeignKeyCriteriaClient
Set CustomSql = @ctmSQL 
,ResolutionSql = @ctmSQL
WHERE Id IN (SELECT mfk FROM @Fields)
