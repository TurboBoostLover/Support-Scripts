...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13593';
DECLARE @Comments nvarchar(Max) = 
	'Updated Text, Removed the inline html';
...
WHERE mt.Active = 1 
	...
	AND mt.MetaTemplateId <> 202 --one of there decactive forms but doesn't include this tab
	AND mt.MetaTemplateId <> 204 --Some course assessment but is a course
...
values
('Course Restrictions', 'CourseProposal', 'RepeatlimitId','Update')
...
SELECT
'SubText',
'The number selected equates to the number of times a student may take the same course including/counting the first time the course is taken.',
FieldId FROM @Fields
