...
DECLARE @JiraTicketNumber nvarchar(20) = 'DST-4946';
...
"
SELECT 'https://google.com', 'http://test.com', 'ftp://test2.com', 'https://stpetersburg.curriqunet.com'
";

SET QUOTED_IDENTIFIER ON 

INSERT INTO AdminReport (ReportName, ReportSQL, OutputFormatId, ShowOnMenu)
VALUES ('Test report', @sql, 1, 0)
