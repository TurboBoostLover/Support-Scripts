...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16248';
DECLARE @Comments nvarchar(Max) = 
	'Fix a bunch of bad attributes';
...
values
('Main', 'CourseCampus', 'CampusId','Colleges'),
('Codes and Dates', 'CourseDate', 'CourseDateTypeId','Codes'),
('Requisites', 'CourseRequisite', 'RequisiteTypeId', 'Req'),
('Entry Skills', 'CourseEntrySkill', 'OptionalText', 'Skill')
...
WHERE f.Action = 'Codes'
and f2.Action = 'Colleges'
UNION
SELECT 'triggersectionrefresh', f.TabId, f2.SectionId FROM @Fields AS f
INNER JOIN @Fields AS f2 on f.TemplateId = f2.TemplateId
WHERE f.Action = 'Skill'
and f2.Action = 'Req'
/****************************** update templates ******************************************/
update MetaTemplate
