...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14805';
...
('Section I - Program Objectives', 'ModuleStrategicGoal', 'MaxText02','Update'),
...
SELECT SectionId, 'Required steps', 'All things from section 1 need to be in section II', 6 ,6, 'Please match the amount to Section I.', @SQL FROM @Fields WHERE Action = 'two'
