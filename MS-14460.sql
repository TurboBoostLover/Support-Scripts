...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14460';
DECLARE @Comments nvarchar(Max) = 
	'Add required drop down to requisite validation tab on courses';
...
values
('Prerequisite/Corequisite', 'CourseRequisite', 'RequisiteTypeId','Ping')
...
SET SectionDescription = '<p class="text-danger">Remember to complete the Prerequisite/Corequisite Validation Page</p>'
