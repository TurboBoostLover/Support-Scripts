...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18428';
DECLARE @Comments nvarchar(Max) = 
	'Add help text to the textbook part 1 fields';
...
values
('Textbooks/Resources', 'GenericMaxText', 'TextMax12','1')
...
WHERE MetaSelectedFieldId in (
	SELECT FieldId FROM @Fields WHERE mtt <> 58
)

INSERT INTO MetaSelectedFieldAttribute
(Name, Value, MetaSelectedFieldId)
SELECT 'helptext', 'For CCN courses only.', FieldId FROM @Fields
/****************************** update templates ******************************************/
update MetaTemplate
