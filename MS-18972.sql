...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18972';
DECLARE @Comments nvarchar(Max) = 
	'Added Triggersection refreshes to update in real time';
...
values
('Programme Content and Structure', 'ProgramSequence', 'SubjectId','Trig'),
('Programme Content Comparison', 'ProgramQueryText', 'QueryText_08', 'list'),
('PILO mapped with Courses', 'ProgramQueryText', 'QueryText_06', 'list')
