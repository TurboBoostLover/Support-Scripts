...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14728 / MS-14727';
DECLARE @Comments nvarchar(Max) = 
	'Add Objectives to Action Steps in PR';
...
values
('Section II: Action Steps', 'ModuleModuleObjective', 'MaxText02','Ping')
...
Select Id as Value,
CASE
	WHEN MaxText01 IS NULL
	THEN 'Empty'
	ELSE MaxText01
END as Text 
From ModuleStrategicGoal
Where Active = 1
And ModuleId = @EntityId
"

DECLARE @RSQL NVARCHAR(MAX) = "
Select MaxText01 As Text 
From ModuleStrategicGoal 
where Id = @Id
"
...
VALUES
(@MAX, 'ModuleStrategicGoal', 'Id', 'Title', @CSQL, @RSQL, 'Order By SortOrder', 'Objective Look up', 2)
