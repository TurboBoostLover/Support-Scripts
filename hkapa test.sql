...
VALUES
(@MAX, 'CourseQueryText', 'Id', 'Title', @SQL, @SQL, 'Order By SortOrder', 'test', 3)
...
1974, -- [MetaAvailableFieldId]
64, -- [MetaSelectedSectionId]
0, -- [IsRequired]
NULL, -- [MinCharacters]
NULL, -- [MaxCharacters]
1, -- [RowPosition]
...
DECLARE @field int = SCOPE_IDENTITY()


insert into MetaSelectedFieldAttribute
(Name,Value,MetaSelectedFieldId)
values
('UpdateSubscriptionTable1','CourseObjective',@field),
('UpdateSubscriptionColumn1','Text',@field)

UPDATE ListItemType
SET ListItemTitleColumn = 'Completion'
WHERE Id = 1
