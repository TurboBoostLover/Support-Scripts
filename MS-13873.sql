...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13873';
DECLARE @Comments nvarchar(Max) = 
	'Delete Course Materials Tab';
...
/********************** Changes go HERE **************************************************/
DELETE FROM CourseSectionSummary WHERE MetaSelectedSectionId in (SELECT TabId FROM @Fields)
...
while exists(select top 1 TabId from @Fields)
	BEGIN
		DECLARE @Sec int = (SELECT TOP 1 TabId FROM @Fields)
