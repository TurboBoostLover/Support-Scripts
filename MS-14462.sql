...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14462';
DECLARE @Comments nvarchar(Max) = 
	'Update Lookup data for advisorys';
...
values
('Advisory/Recommended Preparation', 'CourseWorkOut', 'Lookup14Id_Tier2','Update')
...
UPDATE Lookup14
SET Title = 'Compl (ENGL 102 and ENGL 104)'
WHERE Id = 12
...
SET DisplayName = 'Advisory Math Levels:'
