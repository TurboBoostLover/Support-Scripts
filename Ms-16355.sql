...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16355';
...
values
('Additional Requirements: CTE Programs Only', 'ProgramDetail', 'ProgramAlignment','Delete'),
('Additional Requirements: CTE Programs Only', 'ProgramDetail', 'SimilarPrograms','Update')
...
SET DisplayName = '4. Similar Programs at Other Colleges in Service Area'
