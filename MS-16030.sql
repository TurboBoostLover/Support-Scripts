...
UPDATE MetaSelectedField
SET DisplayName = 'E. Summarize your program’s efforts or strategies implemented during this PR period to redress the recognized institutional outcome disparities'
WHERE MetaSelectedFieldId in (
