...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16528';
DECLARE @Comments nvarchar(Max) = 
	'Update AUO Assessment making things required';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (46)		--comment back in if just doing some of the mtt's
...
values
('Section II - Use of Results', 'ModuleCRN', 'TextMax03','Ping')
...
SET DisplayName = 'Use of Results'
...
exec upUpdateEntitySectionSummary @entityTypeId = 6, @templateId = @template, @entityId = null; --badge update
