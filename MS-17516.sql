...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-asdf';
DECLARE @Comments nvarchar(Max) = 
	'Update Budge Augmentation Request on Instasdfasdfructional Program Review';
...
('Urgent Budget Augmentation Requests', 'ModuleYesNo', 'YesNo09Id', '1')
