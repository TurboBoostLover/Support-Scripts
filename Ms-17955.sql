...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17955';
DECLARE @Comments nvarchar(Max) = 
	'Update Course Materials to new forms';
...
values
('Course Materials', 'GenericOrderedList03', 'MaxText01','1'),
('Course Materials', 'CourseTextbook', 'Title','2'),
('Course Materials', 'CourseManual', 'Title','3'),
('Course Materials', 'CourseSoftware', 'Title','4'),
('Course Materials', 'CourseTextOther', 'TextOther','5')
...
VALUES
('Textbook', 1, 'GenericOrderedList03', 'MaxText01', 0, GETDATE(), 1)
