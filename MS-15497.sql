...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15497';
DECLARE @Comments nvarchar(Max) = 
	'clone and add the following tabs to the Comprehensive Program Reviews';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (501, 503, 505)		--comment back in if just doing some of the mtt's
