...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17301';
DECLARE @Comments nvarchar(Max) = 
	'Update Effective dates to no be required on program forms';
...
values
('General Information', 'GenericDate', 'Date02','Update'),
('General Information', 'GenericDate', 'Date01','Update')
