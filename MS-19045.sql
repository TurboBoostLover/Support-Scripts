...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-19045';
DECLARE @Comments nvarchar(Max) = 
	'Add Header back to form in course blocks';
...
values
('Program Requirements', 'CourseOption', 'Footer','1'),
('Program Requirements', 'CourseOption', 'BlockTypeId','2')
