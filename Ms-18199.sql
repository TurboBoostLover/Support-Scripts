...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18199';
...
values
('IV. Student and Program Outcomes', 'GenericMaxText', 'TextMax01','1'),
('IV. Student and Program Outcomes', 'GenericMaxText', 'TextMax02','2')
...
SET SectionDescription = 'The following questions refer to data regarding student achievement. To access instructional program review data, go to the <a href="https://www.gavilan.edu/about/research/program_review.php" target="_blank">Institution Data Dashboard.</a>'
WHERE MetaSelectedSectionId in (
	SELECT SectionId FROM @Fields WHERE Action = '1'
)

UPDATE MetaSelectedSection
SET SectionDescription = 'The following questions refer to data regarding student achievement. To access program review data, go to the <a href="https://www.gavilan.edu/about/research/program_review.php" target="_blank">Institution Data Dashboard.</a>'
