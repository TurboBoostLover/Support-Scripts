...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13959';
DECLARE @Comments nvarchar(Max) = 
	'Update backing stores as they are duplicated';
...
values
('Requisite Validation', 'GenericBit', 'Bit04','Data'),
('Correspondence Education Addendum', 'GenericBit', 'Bit04','Update')
...
SET MetaAvailableFieldId = 2628	--Bit07
...
UPDATE GenericBit
SET Bit07 = Bit04
FROM GenericBit AS gb
INNER JOIN Course AS c ON gb.CourseId = c.Id
WHERE c.MetaTemplateId in (
