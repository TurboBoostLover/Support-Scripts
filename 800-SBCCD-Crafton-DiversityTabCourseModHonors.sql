...
DECLARE @InsertToMetaTemplateId int = 122; --Set this if inserting sections into a different template Id from the extrated template
DECLARE @InsertToMetaTemplateTypeId int = 91; --Set this if inserting sections into a different template type Id from the extrated template
