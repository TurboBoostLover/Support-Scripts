...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-19630';
DECLARE @Comments nvarchar(Max) = 
	'Add two fields to course codes and dates tab';
...
values
('Codes/Dates', 'CourseProposal', 'ControlNumber','1')
...
UNION
SELECT 
'Cal-GETC Area', -- [DisplayName]
2668, -- [MetaAvailableFieldId]
SectionId, -- [MetaSelectedSectionId]
0, -- [IsRequired]
NULL, -- [MinCharacters]
NULL, -- [MaxCharacters]
