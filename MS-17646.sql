...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17646';
DECLARE @Comments nvarchar(Max) = 
	'Update fioeld not to be required';
...
values
('Discipline Placement', 'CourseMinimumQualification', 'Comments','1')
