...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18955';
DECLARE @Comments nvarchar(Max) = 
	'Update Proposed Implementation Term drop down query';
...
values
('General Programme Information', 'ProgramProposal', 'SemesterId','1'),
('Codes and Dates', 'ProgramProposal', 'SemesterId','1')
...
SET MetaForeignKeyLookupSourceId = 51
, DisplayName = 'Proposed Implementation term and Effective term'
