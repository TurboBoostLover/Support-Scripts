...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14351';
...
('Units/Hours/Content', 'Generic1000Text', 'Text100002','Delete')
...
SET DisplayName = 'Lab and Activity Units'
WHERE MetaSelectedFieldId in (
	SELECT FieldId FROM @Fields WHERE Action = 'Update'
)

UPDATE MetaSelectedField
SET DisplayName = 'Lab and Activity Weekly Contact Hours'
WHERE MetaSelectedFieldId in (
...
UPDATE MetaSelectedField
SET DisplayName = 'Course Lab Activity Content'
WHERE MetaSelectedFieldId in (
	SELECT FieldId FROM @Fields WHERE Action = 'Update5'
)

UPDATE MetaSelectedSection
SET SectionName = 'Notes'
