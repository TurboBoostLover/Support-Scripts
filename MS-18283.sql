...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18283';
DECLARE @Comments nvarchar(Max) = 
	'Update Course Level Assessment Report';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (33)		--comment back in if just doing some of the mtt's
...
values
(NULL, 'ModuleCourseOutcome', 'CourseOutcomeId','1'),
('Course Outcome', 'ModuleCourseOutcomeEvaluationMethod', 'SemesterId','2')
...
SELECT 0 AS Value,
CONCAT('<ol style=""list-style-type: none; padding: 0; margin: 0;""><li>',
dbo.ConcatWithSepOrdered_Agg('<li>', co.SortOrder, CONCAT('<b>',co.OutcomeText, '</b>', '<br>', s.Title, '<br>', '<b>Assessment Methods & Criteria</b>', '<br>', mcoem.MaxText01, '<br>', '<b>Assessment Results</b><br>', mcoem.MaxText02, '<br>', '<b>Assessment Reflection and Analysis</b><br>', mcoem.MaxText03))
,'</ol>') AS Text
FROM Module AS m
...
VALUES
(@MAX, 'ModuleCourseOutcome', 'Id', 'Title', @SQL, @SQL, 'Order By SortOrder', 'Query for report', 2)
