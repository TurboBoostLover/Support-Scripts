...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16827';
DECLARE @Comments nvarchar(Max) = 
	'Add SOC code fields to codes and dates tab';
...
values
('Codes/Dates', 'CourseCBCode', 'CB03Id','Ping')
...
insert into @Fields (FieldId,SectionId,Action,TabId,TemplateId,sortorder, mtt, tabname)
select msf.metaselectedfieldid,msf.MetaSelectedSectionId,rfc.Action,mss.MetaSelectedSectionId,mss.MetaTemplateId ,msf.RowPosition, mt.MetaTemplateTypeId, mss.SectionName
...
WHERE MetaSelectedFieldId in (
	...
	where msf.RowPosition >= f.sortorder
	and f.tabname like '%Codes/Dates%'
)
...
SELECT
'Standard Occupational Classification (SOC) code', -- [DisplayName]
115, -- [MetaAvailableFieldId]
SectionId, -- [MetaSelectedSectionId]
0, -- [IsRequired]
NULL, -- [MinCharacters]
NULL, -- [MaxCharacters]
SortOrder, -- [RowPosition]
0, -- [ColPosition]
1, -- [ColSpan]
