...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18465';
DECLARE @Comments nvarchar(Max) = 
	'Entrance Skills needs to update from Conditions of enrollment tab';
...
values
('Conditions of Enrollment', 'CourseRequisite', 'RequisiteTypeId','1'),
('Entrance Skills', 'GenericCourseMapping02', 'CourseObjective01Id','2')
