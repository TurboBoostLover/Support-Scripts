...
DECLARE @InsertToMetaTemplateId int = 84; --Set this if inserting sections into a different template Id from the extrated template
DECLARE @InsertToMetaTemplateTypeId int = 96; --Set this if inserting sections into a different template type Id from the extrated template
