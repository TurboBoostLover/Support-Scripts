...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13570';
DECLARE @Comments nvarchar(Max) = 
	'Remove Launch Requirements from Program Review';
...
and mt.Active = 1
and mt.IsDraft = 0
and mt.MetaTemplateTypeId = 535 --Program review
...
values
('Program Productivity', 'GenericOrderedList02', 'Int01','Update')
