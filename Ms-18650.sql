...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18650';
DECLARE @Comments nvarchar(Max) = 
	'UPDATE COR for crafton';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (97)		--comment back in if just doing some of the mtt's
...
values
('Course Content', 'Course', 'LectureOutline','1'),
('Course Objectives', 'CourseQueryText', 'QueryTextId_39', '2')
...
select msf.metaselectedfieldid,msf.MetaSelectedSectionId,rfc.Action,mss.MetaSelectedSectionId,mss.MetaTemplateId ,msf.RowPosition, mt.MetaTemplateTypeId, mss.RowPosition
