...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-20075';
DECLARE @Comments nvarchar(Max) = 
	'Take Read only off of sections';
...
values
('NULL', 'CourseEvaluationMethod', 'EvaluationPercentDecimal','1'),
('NULL', 'CourseEvaluationMethod', 'LargeText01','1')
