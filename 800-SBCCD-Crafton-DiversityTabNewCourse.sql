...
DECLARE @InsertToMetaTemplateId int = 81; --Set this if inserting sections into a different template Id from the extrated template
DECLARE @InsertToMetaTemplateTypeId int = 93; --Set this if inserting sections into a different template type Id from the extrated template
