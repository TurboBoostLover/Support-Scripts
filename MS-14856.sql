...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14856';
...
values
('Students completing this course satisfactorily will be able to:', 'CourseOutcomeClientLearningOutcome', 'ClientLearningOutcomeId','Update'),
('Outcomes', 'ProgramOutcomeMatching', 'CourseOutcomeId','Update2'),
('Students who complete this program will be able to:', 'ClientLearningOutcomeProgramOutcome', 'ClientLearningOutcomeId', 'Update3')
