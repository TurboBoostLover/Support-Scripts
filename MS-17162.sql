...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17162';
DECLARE @Comments nvarchar(Max) = 
	'Turn Launching back on';
...
SELECT mss.MetaSelectedSectionId, mss.MetaTemplateId FROM MetaControlAttribute AS mca
INNER JOIN MetaSelectedSection AS mss on mca.MetaSelectedSectionId = mss.MetaSelectedSectionId
WHERE mca.MetaSqlStatementId = 39
