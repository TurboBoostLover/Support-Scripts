...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16632';
DECLARE @Comments nvarchar(Max) = 
	'Make Course Objectives a OL';
...
values
('Course Objectives', 'Course', 'SpecifyTransReq','Ping')
...
SET ReadOnly = 1
, DisplayName = 'Course Objectives (Legacy)'
, IsRequired = 0
...
SELECT Distinct
1, -- [ClientId]
6079, -- [MetaSelectedSection_MetaSelectedSectionId]
'Objective(s)', -- [SectionName]
1, -- [DisplaySectionName]
'Students will be able to:', -- [SectionDescription]
...
VALUES
('Objective', 1, 'CourseObjective', 'Text', 1, GETDATE(), 1)
/****************************** update templates ******************************************/
update MetaTemplate
