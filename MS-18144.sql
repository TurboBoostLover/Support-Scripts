...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18144';
DECLARE @Comments nvarchar(Max) = 
	'Fix duplicate Backingstore issue on form';
...
values
('Cover', 'GenericMaxText', 'TextMax20','1'),
('Cover', 'GenericMaxText', 'TextMax21','2'),
('Cover', 'GenericMaxText', 'TextMax22','3')
...
SET MetaAvailableFieldId = 2967
WHERE MetaSelectedFieldId in (
	SELECT FieldId FROM @Fields WHERE Action = '1'
)

UPDATE MetaSelectedField
SET MetaAvailableFieldId = 2968
WHERE MetaSelectedFieldId in (
	SELECT FieldId FROM @Fields WHERE Action = '2'
)

UPDATE MetaSelectedField
SET MetaAvailableFieldId = 2969
WHERE MetaSelectedFieldId in (
