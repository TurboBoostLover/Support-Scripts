...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14847';
DECLARE @Comments nvarchar(Max) = 
	'Update Tab to new forms for groupcheck list';
...
values
('Program Goals and Outcomes', 'ProgramOutcomeMatching', 'CourseOutcomeId','Update')
...
SELECT 'lookuptablename','ProgramOutcomeMatching',SectionId FROM @Fields
UNION
SELECT 'lookupcolumnname','CourseOutcomeId',SectionId FROM @Fields
UNION
SELECT 'columns','1', SectionId FROM @Fields
UNION
SELECT 'grouptablename', 'ProgramOutcomeMatching', SectionId FROM @Fields
UNION
SELECT 'groupcolumnname', 'ProgramCourseId', SectionId FROM @Fields
/****************************** update templates ******************************************/
update MetaTemplate
