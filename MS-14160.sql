...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14160';
...
('Codes and Dates', 'Program', 'UserId','Update2'),
('Codes and Dates', 'ProgramCBCode', 'CB03Id','Update3')
...
INSERT INTO ProgramDateType
(Title, SortOrder, ClientId, StartDate)
VALUES
('Curriculum Committee Approval', 1, 1, GETDATE()),
('Board of Trustees Approval', 2, 1, GETDATE())
/****************************** update templates ******************************************/
update MetaTemplate
