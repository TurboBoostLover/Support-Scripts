...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14399';
DECLARE @Comments nvarchar(Max) = 
	'Reorder Cover Tab and set CB00 to not required';
...
values
('Cover', 'CourseCBCode', 'CB03Id','Update'),
('Cover', 'CourseCBCode', 'CB04Id','Update2'),
('Cover', 'CourseCBCode', 'CB05Id','Update3'),
('Codes/Dates', 'CourseCBCode', 'CB00','Update4')
