...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18140';
DECLARE @Comments nvarchar(Max) = 
	'Add Group to course objectives';
...
values
('Course Objectives', 'CourseObjective', 'Text','1')
...
(Title, ListItemTableName, ListItemTitleColumn, ListItemTypeOrdinal, ClientId, SortOrder, StartDate)
VALUES
('Group', 'CourseObjective', 'OptionalText', 2, 1, 2, GETDATE())
