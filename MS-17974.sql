...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17974';
DECLARE @Comments nvarchar(Max) = 
	'Update Syllabus report to display weekly course info in a table';
...
values
('Weekly Course Information', 'CourseArticulationAgreement', 'Int01','Ping'),
('Weekly Course Information', 'CourseArticulationAgreement', 'MaxText01','Ping2'),
('Weekly Course Information', 'CourseArticulationAgreement', 'MaxText02','Ping2'),
('Weekly Course Information', 'CourseArticulationAgreement', 'MaxText03','Ping2'),
('Weekly Course Information', 'CourseArticulationAgreement', 'MaxText04','Ping2')
...
SELECT 0 AS Value,
    CONCAT('<table class=""border table-bordered border-dark caption-top"" style=""width:100%;"">',
        '<tr>',
            '<th class=""p-2"">Week</th>',
            '<th class=""p-2"">Topic</th>',
            '<th class=""p-2"">Required Readings</th>',
            '<th class=""p-2"">Assignment, Assessment (with grade weighting) & Due Date</th>',
            '<th class=""p-2"">CLOs Mapping to the Assessment</th>',
        '</tr>',
        dbo.ConcatWithSepOrdered_Agg(NULL, caa.SortOrder, 
            CONCAT('<tr>',
                    '<td class=""p-2 text-center"">', Int01, '</td>',
                    '<td class=""p-2 text-center"">', MaxText01, '</td>',
                    '<td class=""p-2 text-center"">', MaxText02, '</td>',
                    '<td class=""p-2 text-center"">', MaxText03, '</td>',
                    '<td class=""p-2 text-center"">', MaxText04, '</td>',
                '</tr>'
            )
        ), 
    '</table>') AS Text
FROM CourseArticulationAgreement AS caa
WHERE caa.CourseId = @EntityId
"
...
VALUES
(@MAX, 'CourseArticulationAgreement', 'Id', 'Title', @SQL, @SQL, 'Order By SortOrder', 'Syllabus Course Information output', 2)

UPDATE MetaSelectedField
SET MetaAvailableFieldId = 8952
