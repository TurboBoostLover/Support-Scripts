...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15829';
DECLARE @Comments nvarchar(Max) = 
	'Update Group checklist';
...
values
('Students who complete this program will be able to:', 'ProgramOutcomeMatching', 'ProgramCourseId','Update'),
('Students who complete this program will be able to:', 'ClientLearningOutcomeProgramOutcome', 'ClientLearningOutcomeParentId','Update2'),
('Program Student Learning Outcomes', 'ProgramOutcome', 'Outcome', 'OL')
...
and Name in (
	'ParentTable', 'ForeignKeyToParent', 'LookupTable', 'ForeignKeyToLookup'
)
/****************************** update templates ******************************************/
update MetaTemplate
