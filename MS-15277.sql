...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15277';
DECLARE @Comments nvarchar(Max) = 
	'Add help text to Course Blocks tab';
...
values
('Course Blocks', 'CourseOption', 'CourseOptionNote','Update')
...
SET SectionDescription = '<p class="text-danger">Must match narrative document and/or Transfer Model Curriculum (TMC) if Associate Degree for Transfer (ADT)</p>'
