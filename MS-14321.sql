...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14321';
DECLARE @Comments nvarchar(Max) = 
	'Fix Configuration error on form';
...
values
('Cover', 'CourseDate', 'CourseDate','Remove')
...
/********************** Changes go HERE **************************************************/
DECLARE @SEC int = (SELECT SectionId FROM @Fields WHERE Action = 'Remove')
