...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15279';
DECLARE @Comments nvarchar(Max) = 
	'Update Field to be required on the Main tab on programs labeled Months to Completion';
...
values
('Main', 'ProgramProposal', 'EndYear','Update')
