...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14290';
DECLARE @Comments nvarchar(Max) = 
	'Delete field from syllabus';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (8, 18, 4, 16)
...
values
('Grading System', 'CourseYesNo', 'YesNo15Id','Update')
...
DECLARE @SQL nvarchar(max) = '
		...
		select 0 as [Value]
			, (''
				Attendance will be calculated as a percentage of class days attended according to the following point system:
				<ul>
					<li>Present (P) = 2 points</li>
					<li>Absent (A) = 0 points</li>
					<li>Late (L) = 1 point</li>
					<li>Excused (E) = 2 points.</li>
				</ul>
			'') as [Text]
		;
...
, FieldStyle = 0
, FieldTypeId = 5
, MetaForeignKeyLookupSourceId = 140
, IsRequired = 0
, Width = 100
, WidthUnit = 2
, Height = 100
