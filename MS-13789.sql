...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13789';
DECLARE @Comments nvarchar(Max) = 
	'Update Compton Field width on programs';
...
values
('Feasibility', 'Generic2000Text', 'Text200004','Update'),
('Feasibility', 'Generic2000Text', 'Text200001','Update'),
('Feasibility', 'Generic2000Text', 'Text200002','Update'),
('Feasibility', 'Program', 'ChangeRequest','Update'),
('Feasibility', 'Program', 'FacilityEquipmentPlan','Update'),
('Feasibility', 'Program', 'LibraryInformation','Update'),
('Feasibility', 'Program', 'EmployerSurvey', 'Update')
