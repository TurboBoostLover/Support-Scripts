...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15284';
DECLARE @Comments nvarchar(Max) = 
	'Add show hide to textbooks tab';
...
values
('Textbooks/Resources', 'CourseYesNo', 'YesNo09Id','Trigger'),
('Textbooks/Resources', 'GenericOrderedList01', 'Lookup14Id', 'Listener')
...
SELECT TemplateID, FieldId, NULL FROM @Fields AS F
 WHERE f.Action = 'Trigger'
 UNION
 SELECT TemplateId, NULL, SectionId FROM @Fields AS F
 WHERE f.Action = 'Listener'


while exists(select top 1 TID from @SHOWHIDE)
begin
	...
	DECLARE @DisplayRuleName NVARCHAR(50) = 'Show/hide Zero Cost Texbook Section';    
	DECLARE @SubscriberName NVARCHAR(50) = 'Show/hide Zero Cost Texbook Section';    
