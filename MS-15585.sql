...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15585';
DECLARE @Comments nvarchar(Max) = 
	'Add check box on course forms';
...
SELECT
'Six Year Review', -- [DisplayName]
1759, -- [MetaAvailableFieldId]
