...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16959';
DECLARE @Comments nvarchar(Max) = 
	'add help text to RTE';
...
values
('Course Content', 'Course', 'LectureOutline','Ping')
...
SELECT 'helptext', 'If you cannot see text in the fields below, click inside the text box and it will expand to show the full content.', FieldId FROM @Fields WHERE action = 'Ping'
