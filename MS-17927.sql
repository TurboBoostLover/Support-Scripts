...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17927';
...
<div class="fs-5 text-black font-weight-bold py-2 sub-title"><i class="fa fa-fw fa-list me-1" aria-hidden="true"></i>The following illustrates the programme intended learning outcomes</div>
