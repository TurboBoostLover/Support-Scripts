...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13657';
DECLARE @Comments nvarchar(Max) = 
	'Delete field from program form';
...
WHERE mt.Active = 1 
	...
	AND mtt.MetaTemplateTypeId <> 98 --hardcode to remove it
...
values
('Noncredit Documentation', 'ProgramDetail', 'ComprehensiveExamtypeId','Remove')
...
DELETE FROM MetaSelectedField WHERE MetaSelectedFieldId in (SELECT FieldId FROM @Fields)
