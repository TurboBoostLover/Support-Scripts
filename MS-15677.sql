...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15677';
DECLARE @Comments nvarchar(Max) = 
	'Add auto update tab on program forms';
...
values
('Program Information', 'ProgramSequence', 'SubjectId','Trigger'),
('Program Mapper', 'CourseOption', 'CourseOptionNote', 'Listener'),
('Program Map', 'ProgramCourse', 'ProgramCourseRule', 'Update')
...
SELECT 'triggersectionrefresh', f2.TabId, f.SectionId
FROM @Fields AS f
