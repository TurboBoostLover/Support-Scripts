...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18857';
...
DECLARE @Textbook TABLE (CourseId int, txt NVARCHAR(MAX))
...
SELECT CourseId, dbo.ConcatWithSepOrdered_Agg(''<br>'', SortOrder, MaxText02)
