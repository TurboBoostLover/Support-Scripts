...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16965';
DECLARE @Comments nvarchar(Max) = 
	'Update Diversity tab RTE to be required';
...
('Diversity, Equity, Inclusion and Accessibility', 'GenericMaxText', 'TextMax11','Update'),
('Diversity, Equity, Inclusion and Accessibility', 'GenericMaxText', 'TextMax12','Update'),
('Diversity, Equity, Inclusion and Accessibility', 'GenericMaxText', 'TextMax13','Update')
