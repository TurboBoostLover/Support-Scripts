...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18391';
DECLARE @Comments nvarchar(Max) = 
	'Update Tab and field name';
...
values
('Student Learning Outcomes', 'GenericMaxText', 'TextMax08','1')
...
SET SectionName = 'Student Learning Outcomes and Objectives'
WHERE MetaSelectedSectionId in (
	SELECT TabId FROM @Fields
)

UPDATE MetaSelectedField
SET DisplayName = 'Objectives'
