...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14834';
...
WHERE mt.Active = 1
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (2, 11)		--comment back in if just doing some of the mtt's
...
values
('Program Learning Outcomes', 'ClientLearningOutcomeProgramOutcome', 'ClientLearningOutcomeId','Update')
