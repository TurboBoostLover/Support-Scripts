...
DECLARE @Comments nvarchar(Max) = 
	'Update Report, Create new Report, Delete Chemisty Request';
...
WHERE mt.Active = 1 
	...
	and mtt.MetaTemplateTypeId = 35 --TYPE COURSE SLO REPORT
...
values
('Disaggregate Total', 'ModuleYesNo', 'YesNo07Id','Update')
...
values
(
'What insights can you draw about student learning in this course from the aggregate and disaggregate data provided in this report?', -- [DisplayName]
...
,
(
'Based on your experience assessing the course SLOs, what changes would you recommend to the outcomes and/or assessments?', -- [DisplayName]
...
INSERT INTO MetaReportTemplateType (MetaReportId, MetaTemplateTypeId, StartDate, EndDate)
VALUES 
(57, 61, GETDATE(), NULL) --attach all fields report to Resource Proposal
