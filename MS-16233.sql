...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16233';
DECLARE @Comments nvarchar(Max) = 
	'Fix bad form configuration for Maverick';
...
values
('Ping', 'ModuleDetail', 'Tier1_OrganizationEntityId','Update'),
('Ping', 'ModuleDetail', 'Tier2_OrganizationEntityId','Update')
