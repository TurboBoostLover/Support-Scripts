...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13529';
...
values
('Course Materials', 'CourseTextbook', 'Author','Add')
...
INSERT INTO @tempId
	SELECT MetaSelectedSection_MetaSelectedSectionId FROM MetaSelectedSection
	WHERE MetaSelectedSectionId in (Select SectionId from @Fields)

Update MetaSelectedSection
	SET SectionDescription = 'Must list OER materials in Other Materials',
		DisplaySectionDescription = 1
WHERE MetaSelectedSectionId in (SELECT * FROM @tempId)
/****************************** update templates ******************************************/
update MetaTemplate
