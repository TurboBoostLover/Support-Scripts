...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16823';
DECLARE @Comments nvarchar(Max) = 
	'Update Maverick issues found';
...
SET SectionName = 'Methods of Evaluation'
WHERE SectionName like 'Methods of Evaluation%'

insert into @FieldCriteria (TabName, TableName, ColumnName,Action)
values
('Units and Hours', 'CourseAttribute', 'InstructionalCodeId','Update1'),
('Credit', 'CourseProposal', 'IsRequired2', 'Update2'),
('Methods of Evaluation', 'CourseDetail', 'Lookup02Id_01', 'Update3')
...
and Value like '%18 hours%'

UPDATE MetaSelectedSection
SET SectionDescription = '1 Lecture unit = 18 hours, 1 Lab unit = 54 Hours'
