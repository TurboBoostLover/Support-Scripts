...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18299';
DECLARE @Comments nvarchar(Max) = 
	'Update Validation to pass when the course is active';
...
SELECT 
	Case
		WHEN c.StatusAliasId in (157,158, 159, 161, 163, 492) THEN 1
		when exists (
			select top 1 1
			from dbo.Course c2
