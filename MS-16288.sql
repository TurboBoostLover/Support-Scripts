...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16288';
...
values
('Requisites/Requisite Validation', 'CourseQueryText', 'QueryText_01','Update')
...
SELECT 'UpdateSubscriptionMetaBaseSchemaId', 109, FieldId FROM @Fields
/****************************** update templates ******************************************/
update MetaTemplate
