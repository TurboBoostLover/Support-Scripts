...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14861';
DECLARE @Comments nvarchar(Max) = 
	'Update Group Checklist to new forms';
...
SET ListItemTypeId = (SELECT Id FROM ListItemType WHERE ListItemTableName = 'ProgramOutcome' AND ListItemTypeOrdinal = 1)
...
WHERE msf.MetaForeignKeyLookupSourceId in (1, 2)
)
