...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13604';
DECLARE @Comments nvarchar(Max) = 
	'Update OutputTemplate for Catalog';
...
VALUES
(NULL, @ID, NULL, 1, 'Program Requirement links', 'Set a client key to include the links to not effect the base', NULL)
