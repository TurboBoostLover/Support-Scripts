...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14481';
DECLARE @Comments nvarchar(Max) = 
	'Add some help text on course forms';
...
values
('Program Status', 'CourseDescription', 'TransferAppsId','Update')
...
SELECT FieldId, 'SubText', '<p style="color: red;">New courses are CSU only transferable until approved by the UC system</p>' FROM @Fields
