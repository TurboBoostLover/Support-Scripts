...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-19848';
DECLARE @Comments nvarchar(Max) = 
	'Update Course Req tab with new functionality';
...
values
('Requisites/Advisories', 'CourseRequisite', 'RequisiteTypeId','1')
...
SELECT 'listitemtype', 3, FieldId FROM @Fields WHERE Action = '1'
