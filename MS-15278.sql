...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15278';
DECLARE @Comments nvarchar(Max) = 
	'Add help text to Attach Files tab';
...
values
('Attach Files', 'ProgramAttachedFile', 'AttachedFileName','Update')
...
SET SectionDescription = '<p class="text-danger">Program information provided on the narrative document must match information provided in CurriQunet</p>'
