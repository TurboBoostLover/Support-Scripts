...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18626';
DECLARE @Comments nvarchar(Max) = 
	'Update Non-Instructional PSR Annual Update';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (37, 42)		--comment back in if just doing some of the mtt's
...
values
('ACES-ILOs Assessment Plan', 'ModuleYesNo', 'YesNo30Id','1')
