...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17177';
DECLARE @Comments nvarchar(Max) = 
	'Fix round 2 of the same script';
...
values
('Cover', 'CourseAttribute', 'CrossListed_CourseId', 'Update1')
...
, SectionDescription = '<span class="text-danger">If you need to create a new cross listing, contact your local META system administrator.</span>'
WHERE MetaSelectedSectionId in (
