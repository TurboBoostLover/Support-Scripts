...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14512';
DECLARE @Comments nvarchar(Max) = 
	'Update Textbook Tab to add oer section';
...
values
('Textbooks', 'CourseManual', 'Author','Move'),
('Textbooks', 'CoursePeriodical', 'Author','Move'),
('Textbooks', 'CourseSoftware', 'Title','Move'),
('Textbooks', 'CourseTextOther', 'TextOther','Move')
...
DECLARE @TEMP int = (SELECT DISTINCT TemplateId FROM @Fields WHERE Action = 'Move')
...
(
1, -- [ClientId]
676, -- [MetaSelectedSection_MetaSelectedSectionId]
'OER Textbook', -- [SectionName]
...
,
(
'Edition/Version', -- [DisplayName]
255, -- [MetaAvailableFieldId]
@SEC, -- [MetaSelectedSectionId]
0, -- [IsRequired]
NULL, -- [MinCharacters]
NULL, -- [MaxCharacters]
...
,
(
'ISBN/URL/License', -- [DisplayName]
257, -- [MetaAvailableFieldId]
@SEC, -- [MetaSelectedSectionId]
0, -- [IsRequired]
NULL, -- [MinCharacters]
NULL, -- [MaxCharacters]
