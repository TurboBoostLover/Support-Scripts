...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17098';
DECLARE @Comments nvarchar(Max) = 
	'Add CB13 to the course Standards tab';
...
values
('Course Standards', 'CourseSeededlookup', 'CipCode_SeededId','Ping')
...
SELECT DISTINCT
'CB13: Special Class Status', -- [DisplayName]
1008, -- [MetaAvailableFieldId]
SectionId, -- [MetaSelectedSectionId]
CASE WHEN mtt in (8, 11, 12, 19) THEN 0 ELSE
1 END, -- [IsRequired]
NULL, -- [MinCharacters]
NULL, -- [MaxCharacters]
SortOrder + 1, -- [RowPosition]
0, -- [ColPosition]
1, -- [ColSpan]
...
NULL, -- [LiteralValue]
CASE WHEN mtt in (8, 11, 12, 19) THEN 1 ELSE
0 END, -- [ReadOnly]
1, -- [AllowCopy]
NULL, -- [Precision]
NULL, -- [MetaForeignKeyLookupSourceId]
3439, -- [MetadataAttributeMapId]
NULL, -- [EditMapId]
