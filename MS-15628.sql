...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15628';
DECLARE @Comments nvarchar(Max) = 
	'Update OL to show detail';
...
values
('Core Content', 'CourseOutline', 'LectureOutlineText','Update')
...
SELECT 'ShowDetails', 'TRUE', SectionId FROM @Fields WHERE Action = 'Update'
/****************************** update templates ******************************************/
update MetaTemplate
