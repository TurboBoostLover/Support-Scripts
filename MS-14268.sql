...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14268';
DECLARE @Comments nvarchar(Max) = 
	'Update Syllabi Template and report';
...
values
('Library Assignment', 'Course', 'COURSE_DESC','Update')
...
/********************** Changes go HERE **************************************************/
DECLARE @Library int = (SELECT TabId FROM @Fields WHERE Action = 'Update')

EXEC spBuilderSectionDelete @clientId, @Library
