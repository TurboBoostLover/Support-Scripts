...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16961';
...
values
('Appropriate Textbook/Course Fees', 'CourseManual', 'Author','Move'),
('Appropriate Textbook/Course Fees', 'CoursePeriodical', 'Title','Move'),
('Appropriate Textbook/Course Fees', 'CourseSoftware', 'Title','Move'),
('Appropriate Textbook/Course Fees', 'CourseTextOther', 'TextOther','Move'),
('Appropriate Textbook/Course Fees', 'CourseTextbook', 'Author','Ping')
...
UPDATE ListItemType
SET Title = 'OER Textbook'
,ListItemTitleColumn = 'Rationale'
WHERE Id = 16

DECLARE @Secs INTEGERS
...
output inserted.MetaSelectedSectionId INTO @Secs
SELECT DISTINCT
1, -- [ClientId]
TabId, -- [MetaSelectedSection_MetaSelectedSectionId]
'OER Textbooks', -- [SectionName]
...
UNION
SELECT
'Publish Date', -- [DisplayName]
5993, -- [MetaAvailableFieldId]
Id, -- [MetaSelectedSectionId]
0, -- [IsRequired]
NULL, -- [MinCharacters]
NULL, -- [MaxCharacters]
