...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14081';
DECLARE @Comments nvarchar(Max) = 
	'Update fields to have mfkcc';
...
values
('Codes', 'ProgramDate', 'ProgramDateTypeId','Update')
...
VALUES
(@MAX, 'ProgramDate', 'ProgramDateTypeId', 'Id', @SQL, @SQL2, 'Show Date pickers for client and district', 1)
