...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17430';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (15)		--comment back in if just doing some of the mtt's
...
values
('null', 'Course', 'LectureOutline','ping')
...
SELECT 0 AS Value, LectureOutline AS Text FROM Course WHERE Id = @EntityId
"
...
VALUES
(@MAX, 'Course', 'Id', 'Title', @SQL, @SQL, 'Order By SortOrder', 'Content', 2)
