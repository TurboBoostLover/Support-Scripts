...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-12981';
DECLARE @Comments nvarchar(Max) = 
	'Add tab validation to Course Blocks so they cant have the same course twice';
...
values
('Course Requirements', 'CourseOption', 'CourseOptionNote','Ping')
...
SELECT TabId, 'No Duplicate Courses', 6, 'There are duplicate courses in the Course Blocks.', @ID FROM @Fields
/****************************** update templates ******************************************/
update MetaTemplate
