...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14354';
DECLARE @Comments nvarchar(Max) = 
	'Update text on homework tab';
...
values
('Homework', 'CourseDescription', 'MaxWorkHour','Update')
...
SET SectionName = 'Homework'
WHERE MetaSelectedSectionId in (
	SELECT TabId FROM @Fields WHERE Action = 'Update'			---bad data on tab with a empty space
)

UPDATE MetaSelectedSection
SET SectionName = '(e.g. 2 hours per lecture unit or 1 hour activity unit)'
WHERE MetaSelectedSectionId in (
