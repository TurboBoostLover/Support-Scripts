...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15901';
DECLARE @Comments nvarchar(Max) = 
	'Fix issue on weight tab';
...
values
('Assessment Methods Weighting', 'CourseEvaluationMethod', 'EvaluationPercentDecimal','1'),
...
/********************** Changes go HERE **************************************************/
DECLARE @StaticText int = (SELECT msf.MEtaselectedFieldId
