...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18971';
...
values
('Programme Objective and Learning Outcomes', 'ProgramOutcome', 'Outcome','Trig'),
('Generic Level Descriptor to PILO', 'Program', 'QFLevelId', 'list'),
