...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15621';
DECLARE @Comments nvarchar(Max) = 
	'Update Methods of Instruction on COR';
...
SET CustomSql = '
SELECT 0 AS Value
,concat(''<ol style="list-style-type: &quot;* &quot;;">'',dbo.ConcatWithSepOrdered_Agg('''',IT.SortOrder, ''<li>'' + IT.Title + ''</li>''),''</ol>'')  AS Text
