...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17058';
DECLARE @Comments nvarchar(Max) = 
	'Add Condition drop down back in to the program forms';
...
values
('Course Blocks', 'ProgramCourse', 'ProgramCourseRule','Ping')
