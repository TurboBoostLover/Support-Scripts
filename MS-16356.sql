...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16356';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (434, 417, 424, 431)		--comment back in if just doing some of the mtt's
...
('Course Attributes', 'CourseDescription', 'OutClassHour', 'Delete')
