...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17131';
DECLARE @Comments nvarchar(Max) = 
	'Course Sunset Module';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (508)		--comment back in if just doing some of the mtt's
...
values
('Main', 'ModuleDetail', 'SubjectId','Update'),
('Main', 'ModuleCRN', 'ShortText01','Update'),
('General Information', 'ModuleDetail', 'SubjectId','Update'),
('General Information', 'ModuleCRN', 'ShortText01','Update')
