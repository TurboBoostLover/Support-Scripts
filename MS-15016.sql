...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15016';
DECLARE @Comments nvarchar(Max) = 
	'Clean up course Reactivation Proposal Type';
...
UPDATE ProposalType
SET MetaTemplateTypeId = 1
, AllowMultipleApproved = 0
, AllowReactivation = 1
, ReactivationRequired = 1
, AllowCloning = 0
WHERE Id = 9
