...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13835';
DECLARE @Comments nvarchar(Max) = 
	'Update field to not copy over';
...
WHERE mt.Active = 1 
	...
	AND mtt.MetaTemplateTypeId <> 5 --remove library
...
values
('Basic Program Information', 'ProgramProposal', 'SemesterId','Update')
