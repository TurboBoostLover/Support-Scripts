...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13832';
...
WHERE mt.Active = 1 
	...
	AND mt.MetaTemplateId = 2 --hard code as there are 6 versions
...
values
('Content Validation', 'CourseContentReview', 'TargetContent','Update')
