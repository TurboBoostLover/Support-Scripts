...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-19537';
DECLARE @Comments nvarchar(Max) = 
	'Update the Department drop down on programs to not be read only';
...
values
('General Information', 'Program', 'Tier2_OrganizationEntityId','Drop')
...
WHERE MetaSElectedFieldId IN (
	SELECT FieldId FROM @Fields WHERE Action = 'drop'
)
/****************************** update templates ******************************************/
update MetaTemplate
