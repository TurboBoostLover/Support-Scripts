...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17232';
DECLARE @Comments nvarchar(Max) = 
	'Update Pages to be editable by users';
...
values
('General Education Proposal', 'CourseYesNo', 'YesNo07Id','Ping')
...
WHERE MetaSelectedFieldId in (
	...
	and DefaultDisplayType <> 'QueryText'
)
...
WHERE MetaSelectedSectionId in (
	...
	UNION
		...
		INNER JOIN @Fields AS f on mss2.MetaSelectedSection_MetaSelectedSectionId = f.TabId
)
