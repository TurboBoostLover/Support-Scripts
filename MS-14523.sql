...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14523';
DECLARE @Comments nvarchar(Max) = 
	'Update Occ Program Reviews';
...
DECLARE @SEC int = (SELECT SectionId FROM @Fields WHERE Action = 'Move')
...
UPDATE ModuleDetail
SET Tier2_OrganizationEntityId = 15
WHERE ModuleId = 81
/****************************** update templates ******************************************/
update MetaTemplate
