...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18688';
DECLARE @Comments nvarchar(Max) = 
	'Update Diversity, Equity and Inclustion section on COR';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (3)		--comment back in if just doing some of the mtt's
...
values
('Diversity, Equity & Inclusion', 'Course', 'RequestPlacement','1'),
('Diversity, Equity & Inclusion', 'Course', 'AdvisoryCommittee','1'),
('Diversity, Equity & Inclusion', 'CourseProposal', 'CounselorResults','2')
...
SELECT
'Areas where these concepts are covered', -- [DisplayName]
...
1, -- [AllowCopy]
NULL, -- [Precision]
1, -- [MetaForeignKeyLookupSourceId]
