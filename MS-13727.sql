...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13727';
...
values
('Credits', 'CourseDescription', 'MinClinicalHour','Update')
...
SET Value = 180
WHERE MetaSelectedSectionId in (SELECT SectionId FROM @Fields WHERE sortorder = 3)
