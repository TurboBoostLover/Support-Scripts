...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15553';
DECLARE @Comments nvarchar(Max) = 
	'Add Creative Commons License for OER';
...
values
('Textbooks/Materials', 'CoursePeriodical', 'Required','Ping')
...
SELECT
'Creative Commons License', -- [DisplayName]
133, -- [MetaAvailableFieldId]
