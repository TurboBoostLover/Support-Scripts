...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14295';
DECLARE @Comments nvarchar(Max) = 
	'Update admin repot Gateway Courses';
...
FROM Program AS p
	...
	LEFT JOIN AreaOfInterest AS aoi ON p.PrimaryAreaOfInterestId = aoi.Id
WHERE pc.Bit01 = 1
and p.Active = 1
