...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-19101';
DECLARE @Comments nvarchar(Max) = 
	'Update CHC new Proposam Form';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (72)		--comment back in if just doing some of the mtt's
...
values
('CTE Documentation', 'Program', 'FacEquip','1'),
('CTE Documentation', 'Program', 'AdministrationPlan','1'),
('CTE Documentation', 'Program', 'EntranceRequirementsText','1'),
('CTE Documentation', 'Program', 'Certification','1')
