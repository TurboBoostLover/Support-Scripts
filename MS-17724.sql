...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17724';
DECLARE @Comments nvarchar(Max) = 
	'Make SLO tab only admin viewable only';
...
values
('Student Learning Objectives', 'CourseObjective', 'Text','1')
...
SELECT SectionId, 4, 1 FROM @Fields
