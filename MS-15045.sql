...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15045';
...
values
('Comparable Courses', 'CourseTransferInfo', 'CatalogPage','Ping')
...
WHERE MetaSelectedFieldId in (
	...
	INNER JOIN @Fields AS f on f.SectionId = msf.MetaSelectedSectionId
