...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13784';
DECLARE @Comments nvarchar(Max) = 
	'Update Width of program form fields';
...
WHERE mt.Active = 1 
	...
	--18 SELECT * FROM MetaTemplate WHERE MetaTemplateId = 18
...
('Codes', 'ProgramProposal', 'SemesterId', 'Update2')
