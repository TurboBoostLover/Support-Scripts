...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16887';
DECLARE @Comments nvarchar(Max) = 
	'Update to some course information';
...
VALUES
('Discussion Boards', 0, 51, GETDATE())
...
DECLARE @TABLE TABLE (FieldId int, TempId int)
INSERT INTO @TABLE
SELECT msf.MetaSelectedFieldId, mss.MetaTemplateId FROM MetaSelectedField AS msf
INNER JOIN MetaSelectedSection AS mss on msf.MetaSelectedSectionId = mss.MetaSelectedSectionId
WHERE msf.DisplayName like '%Website%'
and msf.MetaAvailableFieldId = 1529
