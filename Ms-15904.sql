...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15904';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (27, 30)		--comment back in if just doing some of the mtt's
...
values
('Course Approval Date', 'GenericDate', 'Date01','Ping'),
('Course Approval Date', 'CourseQueryText', 'QueryTextId_17','Ping'),
('Course Approval Date', 'CourseProposal', 'SemesterId','Ping'),
('Supporting Documents', 'CourseAttachedFile', 'Title', 'Ping2')
...
SELECT 0 AS Value,
CASE
	WHEN pt.Title like '%Deactivation%'
	THEN '<div class=""col-md-12"" style=""padding-left:0; padding-right:0;""><div class=""h3"">Course Deactivation Approval Date</div><div class=""seperator hr-darker"" style=""width:101.5%""> </div></div>'
	WHEN pt.Title like '%Reactivation%'
	THEN '<div class=""col-md-12"" style=""padding-left:0; padding-right:0;""><div class=""h3"">Course Reactivation Approval Date</div><div class=""seperator hr-darker"" style=""width:101.5%""> </div></div>'
	ELSE '<div class=""col-md-12"" style=""padding-left:0; padding-right:0;""><div class=""h3"">Course Approval Date</div><div class=""seperator hr-darker"" style=""width:101.5%""> </div></div>'
END As Text
FROM Course AS c
...
VALUES
(@MAX, 'ProposalType', 'Id', 'Title', @CSQL, @CSQL, 'Order By SortOrder', 'Look up proposal type', 2)
...
INNER JOIN @Fields as f on f.SectionId = mss.MetaSelectedSectionId
...
WHERE MetaSelectedSectionId in (
	SELECT DISTINCT TabId FROM @Fields WHERE Action = 'Ping'
)
/****************************** update templates ******************************************/
update MetaTemplate
