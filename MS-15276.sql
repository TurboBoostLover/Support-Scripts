...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15276';
DECLARE @Comments nvarchar(Max) = 
	'Add help text to PLO tab';
...
values
('Learning Outcomes (PLOs)', 'ProgramOutcome', 'Outcome','Update')
...
SET SectionDescription = '<p class="text-danger">Must match narrative document</p>'
