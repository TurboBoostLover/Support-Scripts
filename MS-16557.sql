...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16557';
DECLARE @Comments nvarchar(Max) = 
	'Fix the catalog query for Valley';
...
select cr.Id, cr.Parent_Id, cr.RequisiteTypeId, row_number() over (order by cr.Id, cr.SortOrder)
...
WHERE mtt.ClientId = 3
and msf .MetaAvailableFieldId = 3272
and DisplayName like '%Catalog%'


UPDATE MetaSelectedField
SET MetaAvailableFieldId = 8948
...
WHERE MetaTemplateId in (
	...
	WHERE msf.MetaForeignKeyLookupSourceId in (1, 138)
)