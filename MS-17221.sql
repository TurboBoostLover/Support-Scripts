...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17221';
DECLARE @Comments nvarchar(Max) = 
	'Clean up required fields that are admin only';
...
values
('Codes and Dates', 'Course', 'UserId','Ping')
...
WHERE MetaSelectedFieldId in (
	...
	WHERE mss2.MetaSelectedSectionId in (
