...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16381';
...
WHERE MetaSelectedSectionId in (
	SELECT SectionId FROM @Fields WHERE Action in ('1', '2') and secorder = 4
)
...
SET Title = '1B. Critical Thinking And Composition'
WHERE Id = 39
