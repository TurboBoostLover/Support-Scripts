...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17981';
...
Declare @clientId int =5, -- SELECT Id, Title FROM Client 
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (95, 96)		--comment back in if just doing some of the mtt's
...
values
('Assessment', 'ModuleCRN', 'TextMax06','1')
