...
DECLARE @InsertToMetaTemplateId int = 87; --Set this if inserting sections into a different template Id from the extrated template
DECLARE @InsertToMetaTemplateTypeId int = 94; --Set this if inserting sections into a different template type Id from the extrated template
