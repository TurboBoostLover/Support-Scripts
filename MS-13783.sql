...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13783';
DECLARE @Comments nvarchar(Max) = 
	'Update Course Form width';
...
WHERE mt.Active = 1 
	...
	AND mtt.MetaTemplateTypeId NOT IN (484, 500)
	--803, 821  SELECT * FROM MetaTemplate WHERE MetaTemplateId in (803, 821)
...
values
('Codes/Dates', 'CourseProposal', 'MaxEnrollment','Update2'),
('Codes/Dates', 'CourseYearTerm', 'RequestedStartSemesterId','Update'),
('Codes/Dates', 'CourseYearTerm', 'ActualStartSemesterId','Update'),
...
('Codes/Dates', 'CourseYearTerm', 'RequestedStartYear','Update'),
('Codes/Dates', 'CourseYearTerm', 'ActualStartYear','Update'),
