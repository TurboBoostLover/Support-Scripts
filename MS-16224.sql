...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16224';
...
(AdminReportId, AdminReportFilterTypeId, VariableName, FilterLabel, FilterRequired)
VALUES
(@ID, 4, 'date', 'Package Created Date after', 1)
