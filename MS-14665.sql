...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14665';
DECLARE @Comments nvarchar(Max) = 
	'Make fields read only on course mod and deletions';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (484, 496)		--comment back in if just doing some of the mtt's
...
values
('Main', 'Course', 'SubjectId','Update'),
('Main', 'Course', 'CourseNumber','Update')
