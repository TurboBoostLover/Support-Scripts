...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16325';
DECLARE @Comments nvarchar(Max) = 
	'Redo stuff the client asked for and got yelled at by her commitee since she put in tickets she should not of';
...
values
('Student Learning Outcomes', 'CourseOutcome', 'OutcomeText','Ping')
...
'Please check all that align with the Institutional Learning Outcomes (ILOs)', -- [SectionName]
...
SELECT
'Institutional Learning Outcome', -- [DisplayName]
3099, -- [MetaAvailableFieldId]
...
1, -- [AllowCopy]
NULL, -- [Precision]
10, -- [MetaForeignKeyLookupSourceId]
NULL, -- [MetadataAttributeMapId]
NULL, -- [EditMapId]
...
SELECT 1, 1, SecId FROM @Sections

INSERT INTO MetaSelectedSectionAttribute
(Name, Value, MetaSelectedSectionId)
SELECT 'ForeignKeyToLookup', 'ClientLearningOutcomeId', SecId FROM @Sections
UNION
SELECT 'ForeignKeyToParent', 'CourseOutcomeId', SecId FROM @Sections
UNION
SELECT 'LookupTable', 'CourseOutcomeClientLearningOutcome', SecId FROM @Sections
UNION
SELECT 'ParentTable', 'CourseOutcome', SecId FROM @Sections
/****************************** update templates ******************************************/
update MetaTemplate
