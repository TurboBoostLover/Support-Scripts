...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14368';
DECLARE @Comments nvarchar(Max) = 
	'Update Tab name on Admin PR';
...
values
('Section I: Summary Report', 'ModuleCRN', 'TextMax01','Update')
...
SET SectionName = 'Section I: Unit Objectives'
