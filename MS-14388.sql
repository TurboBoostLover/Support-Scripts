...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14388';
DECLARE @Comments nvarchar(Max) = 
	'Update Course Attriubutes tab';
...
values
('Course Attributes', 'CourseGeneralEducation', 'GeneralEducationElementId','Update')
...
VALUES
(5, 'Work-based Learning', 25, GETDATE(), 1)
...
UPDATE GeneralEducationElement
SET Title = 'Course included in a CTE Articulation Agreement'
WHERE Id = 24

update mq 
set SortOrder = sorted.rownum 
output inserted.*
from GeneralEducationElement mq
inner join ( 
