...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16748';
DECLARE @Comments nvarchar(Max) = 
	'Fix stlying so the reports dont look like garbage anymore';
