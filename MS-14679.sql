...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14679';
DECLARE @Comments nvarchar(Max) = 
	'Add originator drop down to Laney PR';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (42, 43)		--comment back in if just doing some of the mtt's
...
values
('Validation', 'ModuleExtension02', 'TextMax07','Ping')
...
--exec upUpdateEntitySectionSummary @entityTypeId = 1, @templateId = 17, @entityId = null; --badge update
