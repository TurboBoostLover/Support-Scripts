...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15941';
...
values
('CSLO Assessment', 'ModuleYesNo', 'YesNo09Id','Update'),
('CSLO Assessment', 'ModuleAttachedFile', 'Title','Update2'),
('II. Curriculum, Instruction and Assessment', 'ModuleCRN', 'TextMax08', 'Update3'),
('II. Curriculum, Instruction and Assessment', 'ModuleCRN', 'TextMax09', 'Update4')
...
DECLARE @TABId int = (SELECT TabId FROM @Fields WHERE Action = 'Update4')

UPDATE MetaSelectedSection
SET RowPosition = 9
, SortOrder = 9
, MetaSelectedSection_MetaSelectedSectionId = @TABId
, SectionName = 'CSLO Assessment'
WHERE MetaSelectedSectionId in (
