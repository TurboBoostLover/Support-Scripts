...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14458';
...
values
('Methods of Evaluation and Examination', 'CourseMethodOfEvaluation', 'OtherMethods','Update')
...
SET DisplayName = 'List Critical Thinking Example. Only required for transferable courses.'
