...
DECLARE @InsertToMetaTemplateId int = 124; --Set this if inserting sections into a different template Id from the extrated template
DECLARE @InsertToMetaTemplateTypeId int = 109; --Set this if inserting sections into a different template type Id from the extrated template
