...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13929';
DECLARE @Comments nvarchar(Max) = 
	'Add attachments back to Assessment 1';
...
WHERE mt.Active = 1 
    ...
    AND mtt.ClientId = @clientId
		AND mtt.MetaTemplateTypeId in (54)		--comment back in if just doing some of the mtt's
...
values
('Assessment Methods / Tools', 'ModuleCRN', 'TextMax02','Ping')
...
SELECT 'FieldSpecialization', 'UploadFilenameField', Id FROM @TABLE WHERE Nam = 'Title'
UNION
SELECT 'FieldSpecialization', 'UploadTextnameField', Id FROM @TABLE WHERE Nam = 'Attached File Name'
UNION
SELECT 'FieldSpecialization', 'UploadDiscnameField', Id FROM @TABLE WHERE Nam = 'Disk Name'
UNION
SELECT 'FieldSpecialization', 'UploadMimetypeField', Id FROM @TABLE WHERE Nam = 'Mime Type'
/****************************** update templates ******************************************/
update MetaTemplate
