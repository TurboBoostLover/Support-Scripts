...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14346';
DECLARE @Comments nvarchar(Max) = 
	'Add postion to assist tabs';
...
values
('ASSIST Preview', 'Course', 'SubjectId','Update'),
('ASSIST', 'Course', 'HasHTMLReport', 'Update2'),
('ASSIST', 'GenericDate', 'Date02', 'Update2'),
('ASSIST', 'GenericDate', 'Date03', 'Update2')
...
SELECT DISTINCT TabId, 8, 2 FROM @Fields WHERE Action in ('Update', 'Update2')

declare @positionId int = (select Id from Position where Title = 'Articulation Officer');
