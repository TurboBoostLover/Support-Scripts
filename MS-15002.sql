...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15002';
	...
	CONCAT(
		...
		<tbody>
		  ...
		  <tr>
		    ...
		    ''<td class="tg-0lax">'',
				CASE
					WHEN cd.MinLabHour is not null and cd.MinLabHour != 0 and cd.MaxLabHour is not null and cd.MaxLabHour != 0 and cd.MinLabHour != cd.MaxLabHour 
