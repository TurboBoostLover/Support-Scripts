...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13821';
...
WHERE MetaAvailableFieldId in (625, 1713, 625)
AND MetaSelectedSectionId in (
	...
	WHERE mt.MetaTemplateId in (15, 16)
)

--Hard code Available Fields and Templates because Template and Template Types are inactive and no course is using these. Verified there
