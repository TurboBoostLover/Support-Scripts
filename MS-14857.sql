...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14857';
...
values
('Course Attributes', 'CourseGeneralEducation', 'GeneralEducationId','Update'),
...
UNION
SELECT 'groupcolumnname', 'ProgramCourseId', SectionId FROM @Fields WHERE Action = 'Update2'
/****************************** update templates ******************************************/
update MetaTemplate
