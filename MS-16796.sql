...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16796';
DECLARE @Comments nvarchar(Max) = 
	'Update Program Modify template';
...
values
('Basic Program Information', 'ProgramCBCode', 'CB03Id','Ping')
...
SELECT DISTINCT
'Significant Change', -- [DisplayName]
2633, -- [MetaAvailableFieldId]
