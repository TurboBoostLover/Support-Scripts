...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18969';
DECLARE @Comments nvarchar(Max) = 
	'Delete Mode of Delivery section and update custom SQL';
...
values
('Mode of Delivery', 'ProgramDeliveryMethod', 'DeliveryMethodId','1')
...
WHERE MetaSelectedSectionId in (
	SELECT SectionId FROM @Fields WHERE Action = '1' and nam = 'Full-Time and Part-time'
)
