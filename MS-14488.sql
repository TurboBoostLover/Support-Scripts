...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14488';
...
values
('VI. Summary, Recommendations and Long-Term Goals', 'ModuleExtension01', 'TextMax14','Update'),
('VI. Summary, Recommendations and Long-Term Goals', 'GenericOrderedList02', 'Text100001', 'Update2')
...
SET SectionName = 'D.	Please use the comment box to provide further context.'
