...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15291';
DECLARE @Comments nvarchar(Max) = 
	'Add help text to Program Main tab';
...
values
('Main', 'Generic2000Text', 'Text200001','Update')
...
SELECT 'helptext', '<p class="text-danger">Must match master planning on narrative document</p>', FieldId FROM @Fields
UNION
SELECT 'SubText', '<p class="text-danger">Must match master planning on narrative document</p>', FieldId FROM @Fields
/****************************** update templates ******************************************/
update MetaTemplate
