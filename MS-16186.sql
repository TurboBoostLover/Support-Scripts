...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16186';
DECLARE @Comments nvarchar(Max) = 
	'Update Form for Lab/Activity Hours';
...
values
('Lab/Activity Content', 'CourseLabContent', 'ApproximatePercentage','Update')
