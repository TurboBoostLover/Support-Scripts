...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-17622';
DECLARE @Comments nvarchar(Max) = 
	'Remove launch requirements on course';
...
values
('Methods of Instruction and Evaluation', 'CourseEvaluationMethod', 'EvaluationMethodId','1')
