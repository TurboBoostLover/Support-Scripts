...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14231';
DECLARE @Comments nvarchar(Max) = 
	'Update Section 1 of Program Review Form';
...
values
('Section I - Program Objectives', 'ModuleObjective', 'ObjectiveText','Update'),
('Improvement Action', 'ModuleObjectiveStrategicGoal', 'StrategicGoalId','Update2')
...
SET MetaBaseSchemaId = 6301
, SectionName = '2020-2025 Strategic Plan Goals and Objectives'
...
VALUES
('lookuptablename','ModuleStrategicGoal',@SEC),
('lookupcolumnname','StrategicGoalId',@SEC),
('columns','1',@SEC)
...
exec upUpdateEntitySectionSummary @entityTypeId = 6, @templateId = @TEMP, @entityId = null; --badge update
