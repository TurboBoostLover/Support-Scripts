...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-18106';
DECLARE @Comments nvarchar(Max) = 
	'Fix some assessment show hide';
...
values
('NULL', 'ModuleCourseOutcomeEvaluationMethod', 'SemesterId','1'),
('Course Outcome', 'ModuleCourseOutcomeEvaluationMethod', 'MaxText01', '2'),
('Course Outcome', 'ModuleCourseOutcomeEvaluationMethod', 'MaxText02', '2'),
('Course Outcome', 'ModuleCourseOutcomeEvaluationMethod', 'MaxText03', '2')
...
concat(''<b>'',Coalesce(OutcomeText,OtherText),''</b>'') as Text 
from CourseOutcome co 
inner join ModuleDetail md on co.CourseId = md.Active_CourseId 
...
SET MetaSelectedSection_MetaSelectedSectionId = @Parent
WHERE MetaSelectedSectionId in (
	SELECT SectionId FROM @Fields WHERE Action = '1'
)

UPDATE MetaDisplaySubscriber
SET MetaSelectedSectionId = @Parent
WHERE MetaSelectedSectionId in (
	SELECT SectionId FROM @Fields WHERE Action = '1'
)
/****************************** update templates ******************************************/
