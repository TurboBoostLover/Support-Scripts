...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-16609';
DECLARE @Comments nvarchar(Max) = 
	'Update Fields to copy over ';
...
values
('General Education/Transfer (Approved)', 'GenericBit', 'Bit01','Update')
...
SELECT DISTINCT TabId, 4, 1 FROM @Fields WHERE Action = 'Update'
UNION
SELECT DISTINCT SectionId, 4, 1 FROM @Fields WHERE Action = 'Update'
/****************************** update templates ******************************************/
update MetaTemplate
