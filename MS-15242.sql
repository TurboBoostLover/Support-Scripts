...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15424';
...
values
('Section IV - Program Overview', 'ModuleCRN', 'ShortText01','Update')
...
SET MetaAvailableFieldId = 4088
WHERE MetaSelectedFieldId in (
	SELECT FieldId FROM @Fields
)

UPDATE mn
SET mn.TextMax06 = mn.ShortText01
From ModuleCRN AS mn
WHERE mn.TextMax06 IS NULL

UPDATE mn
SET mn.ShortText01 = NULL
From ModuleCRN AS mn
WHERE mn.TextMax06 IS  NOT NULL
/****************************** update templates ******************************************/
update MetaTemplate
