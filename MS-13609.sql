...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13609';
...
WHERE mt.Active = 1 
	...
	AND mtt.ClientEntityTypeId IS NULL
...
values
('General Ed', 'CourseGeneralEducation', 'GeneralEducationElementId','Update')
...
WHERE GeneralEducationId = 13

INSERT INTO GeneralEducationElement
(GeneralEducationId, Title, Text, SortOrder, StartDate, EndDate, Objective, Header, Footer, IsCore, ClientId, Code, Description, Active_Old)
VALUES
(13, 'D - Social Sciences', NULL, 1, GETDATE(), NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 1)
...
WHERE ge.Active = 1
AND ge.Title IN (''CSU GE Area D: Social, Political, and Economic Institutions and Behavior, Historical'')
AND gee.Active = 1
