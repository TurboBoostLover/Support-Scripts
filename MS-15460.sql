...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15460';
...
values
('Codes and Dates', 'CourseYearTerm', 'ActualStartSemesterId','Update')
...
s.Title AS [Text]
FROM Semester AS s
INNER JOIN CourseProposal AS cp on cp.SemesterId = s.Id
...
VALUES
(@MAX, 'Semester', 'Id', 'Title', @CSQL, @RSQL, 'Order By SortOrder', 'Show Selected Value even if inactive', 2)

UPDATE MetaSelectedField
SET MetaAvailableFieldId = 586
