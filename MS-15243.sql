...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15243';
DECLARE @Comments nvarchar(Max) = 
	'Update Program Drop down to a multi-select';
...
values
('Cover', 'ModuleDetail', 'Tier2_OrganizationEntityId','Update')
...
select 
ISNULL(Code + ' - ','')  + Title as Text,
Code as Code,
Title as Title
from OrganizationEntity where Id = @id
"
