...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14352';
...
values
('Credit for Prior Learning', 'CourseProposal', 'HasExam','Update')
...
SELECT FieldId, 1,2 FROM @Fields WHERE Action = 'Update'
UNION
SELECT FieldId, 4, 1 FROM @Fields WHERE Action = 'Update'
/****************************** update templates ******************************************/
update MetaTemplate
