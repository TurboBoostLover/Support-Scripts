...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-15567';
DECLARE @Comments nvarchar(Max) = 
	'Remove Ajax field on COR to make it work';
...
values
('NULL', 'CourseDetail', 'Tier2_OrganizationEntityId','Update')
...
SET MetaAvailableFieldId = 8898
, DefaultDisplayType = 'QueryText'
, MetaPresentationTypeId = 103
, Width = 100
, WidthUnit = 2
, LabelStyleId = 1
, MetaForeignKeyLookupSourceId = 33
