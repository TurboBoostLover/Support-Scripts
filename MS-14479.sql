...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-14479';
...
values
('Homework', 'Generic2000Text', 'Text200002','Update')
...
SELECT FieldId, 'SubText', '<p style="color: red;">Should be different than the Method of Evaluation critical thinking example</p>
' FROM @Fields
/****************************** update templates ******************************************/
update MetaTemplate
