...
DECLARE @JiraTicketNumber nvarchar(20) = 'MS-13482';
DECLARE @Comments nvarchar(Max) = 
	'Made Effective Date not copy over';
...
values
('Cover', 'CourseProposal', 'SemesterId','Update'),
('Codes and Dates', 'CourseDate', 'CourseDate', 'Update')
...
where MetaTemplateId in (select Distinct templateId FROM @Fields) --17,18,19,20
